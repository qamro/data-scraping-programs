...
|---|---------|---------|-------------|----------|
| 1 | `1_scraper_beautifulsoup.py` | `requests` + `BeautifulSoup` | [books.toscrape.com](https://books.toscrape.com) | Simple static HTML sites |
...
```
.
├── 1_scraper_beautifulsoup.py     # Program 1: static site scraper
├── 2_scraper_selenium.py          # Program 2: JS-rendered site scraper
├── 3_scraper_proxy_rotation.py    # Program 3: proxy-rotating, concurrent scraper
├── requirements.txt               # Python dependencies for all 3 programs
└── README.md                      # this file
```
